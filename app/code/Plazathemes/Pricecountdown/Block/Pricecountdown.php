...
class Pricecountdown extends \Magento\Catalog\Block\Product\AbstractProduct
{
	...
	public function getSaleFirstProduct() {
		$_product = $this->getSaleProducts()->getFirstItem();
		
		return $_product;
	}
	
	public function getSaleProductsExceptFirst() {
        $_productCollection=$this->getSaleProducts();
        $_firstProduct = $this->getSaleFirstProduct();
